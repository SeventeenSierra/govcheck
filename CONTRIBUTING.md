# Contributing to GovCheck

Thank you for your interest in contributing to the GovCheck (Contract Checker) project! This document explains our contribution process for this Federal Compliance compliance validation system.
...
- `compliance` - Federal Compliance validation logic
- `orchestration` - Federated mesh patterns

### Examples

```bash
git commit -s -m "feat(strands): add Federal Compliance Section 2.B validation"
