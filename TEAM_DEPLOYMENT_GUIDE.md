# GovCheck - Ready for Team Deployment

## Executive Summary

The GovCheck (Contract Checker) application is now **fully deployment-ready** for your team to use and contribute to. All services are containerized, documented, and tested.
...
### Getting Help
- Check service logs: `docker-compose -p govcheck logs -f`
