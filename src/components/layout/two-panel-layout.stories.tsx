...
const meta: Meta<typeof TwoPanelLayout> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible two-panel layout with responsive behavior, smooth transitions, and optional resizing.',
      },
    },
  },
  argTypes: {
  ...
  <div className="p-6 h-full flex flex-col">
    ...
    <div className="flex-1 bg-gray-50 rounded-lg p-4">
      <p className="text-sm text-gray-500">
        This area would typically contain your main application content,
        such as a chat interface, document editor, or data visualization.
      </p>
    </div>
  </div>
);
...
const RightPanelContent = () => (
  <div className="p-6 h-full">
    <div className="bg-white border border-gray-200 rounded-lg p-4 h-full">
      ...
      <p className="text-gray-600 mb-4">
        This is the right panel content. It could be a sidebar, preview pane,
        or additional tools.
      </p>
  ...
  return (
    <div className="h-screen">
      <TwoPanelLayout
        ...
        leftPanel={<LeftPanelContent onToggle={() => setIsRightPanelVisible(!isRightPanelVisible)} />}
