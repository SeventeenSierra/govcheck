...
Thank you for your interest in contributing to Seventeen Sierra projects.

By signing this Contributor License Agreement ("Agreement"), you accept and agree to the following terms and conditions for your present and future Contributions submitted to Seventeen Sierra LLC ("Company").
...
**"Contribution"** means any original work of authorship, including any modifications or additions to an existing work, that is intentionally submitted by You to the Company for inclusion in any of the products owned or managed by the Company.

**"Submitted"** means any form of electronic, verbal, or written communication sent to the Company, including but not limited to communication on electronic mailing lists, source code control systems, and issue tracking systems.

## 2. Grant of Copyright License

Subject to the terms and conditions of this Agreement, You hereby grant to the Company and to recipients of software distributed by the Company a perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable copyright license to:
...
This CLA is signed electronically via [CLA Assistant](https://cla-assistant.io/) when you submit your first pull request.

For questions: **legal@seventeensierra.com**
