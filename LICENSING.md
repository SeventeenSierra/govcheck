...
The GovCheck (Contract Checker) project uses a **multi-license strategy** to balance open source principles with commercial viability for NSF PAPPG compliance validation.
...
The core GovCheck services and applications are proprietary:
