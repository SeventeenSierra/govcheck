# API Integration Guide - Connecting to the Proposal Prepper UI

> **For Backend Developers**: This guide explains how to integrate your backend services with the existing Proposal Prepper web UI.
...
The Proposal Prepper application uses a **federated mesh microservices** architecture:
...
**Issues?**
- Check service logs: `docker-compose -p proposal-prepper logs strands`
